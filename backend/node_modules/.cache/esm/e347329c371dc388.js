let express,swaggerUi,bodyParser,cors,path,fs,InputError,AccessError,swaggerDocument,getEmailFromAuthorization,login,logout,register,getStore,setStore,save,setup;_371‍.x([["default",()=>_371‍.o]]);_371‍.w("express",[["default",["express"],function(v){express=v}]]);_371‍.w("swagger-ui-express",[["default",["swaggerUi"],function(v){swaggerUi=v}]]);_371‍.w("body-parser",[["default",["bodyParser"],function(v){bodyParser=v}]]);_371‍.w("cors",[["default",["cors"],function(v){cors=v}]]);_371‍.w("path",[["default",["path"],function(v){path=v}]]);_371‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_371‍.w("./error",[["InputError",["InputError"],function(v){InputError=v}],["AccessError",["AccessError"],function(v){AccessError=v}]]);_371‍.w("./swagger.json",[["default",["swaggerDocument"],function(v){swaggerDocument=v}]]);_371‍.w("./service",[["getEmailFromAuthorization",["getEmailFromAuthorization"],function(v){getEmailFromAuthorization=v}],["login",["login"],function(v){login=v}],["logout",["logout"],function(v){logout=v}],["register",["register"],function(v){register=v}],["getStore",["getStore"],function(v){getStore=v}],["setStore",["setStore"],function(v){setStore=v}],["save",["save"],function(v){save=v}],["setup",["setup"],function(v){setup=v}]]);// // // // // import fs from 'fs';
